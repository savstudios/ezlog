...
{
    if (m_LogLevel < logLevels::Log_Trace) {return;}
...
{
    if (m_LogLevel < logLevels::Log_Debug) {return;}
...
{
    if (m_LogLevel < logLevels::Log_Info) {return;}
...
{
    if (m_LogLevel < logLevels::Log_Warn) {return;}
...
{
    if (m_LogLevel < logLevels::Log_Error) {return;}
